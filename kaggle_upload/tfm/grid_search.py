...
# --- Red y reglas ---
# os.path.join con componentes sueltos => separador correcto en cada SO
# (Windows '\', Linux/Kaggle '/'). No usar literales con '\' embebido.
BASE_FOLDER = os.path.join("example", "nhlv1")
# BASE_FOLDER = os.path.join("example", "bypass2")
...
def run_grid_for_optimizer(effective_config, base_folder):
    ...
    # base_folder puede apuntar a un sitio que aún no existe (p.ej. una carpeta
    # de salida dedicada en /kaggle/working). Lo creamos para que ensure_csv_header
    # no falle al abrir el CSV para escribir.
